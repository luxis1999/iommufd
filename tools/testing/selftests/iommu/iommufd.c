...
TEST_F(iommufd_device_pasid, pasid_attach)
{
	...
	test_err_cmd_pasid_attach(EINVAL, pasid, s2_hwpt_id);
	 ...
	 */
	test_err_cmd_pasid_attach(EINVAL, pasid, parent_hwpt_id);
	ASSERT_EQ(0,
	 ...
	 * fail with -EINVAL.
	 */
	test_err_cmd_pasid_replace(EINVAL, pasid, s2_hwpt_id);
